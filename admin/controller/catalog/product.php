	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			foreach( $this->model_localisation_language->getLanguages() as $language ) {
				if ( isset( $this->request->post['product_description'][$language['language_id']]['tag'] ) )
					$this->request->post['product_description'][$language['language_id']]['tag'] = implode( ',', $this->request->post['product_description'][$language['language_id']]['tag'] );
				else
					$this->request->post['product_description'][$language['language_id']]['tag'] = '';
			}
	...
	protected function getForm() {
		...
		if ( $data['product_description'] ) {
			foreach( $data['languages'] as $language ) {
				$data['product_description'][$language['language_id']]['tag'] = explode( ',', $data['product_description'][$language['language_id']]['tag'] );
			}
		}
		
		$data['product_tags'] = array(
			array( 'name' => 'Горячее', 'value' => 'hot' ),
			array( 'name' => 'Отображать на главной', 'value' => 'main' ),
			array( 'name' => 'Рекоммендуемое в корзине', 'value' => 'cart' ),
		);
