...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        if (isset($this->error['deliveries'])) {
            $data['error_deliveries'] = $this->error['deliveries'];
        } else {
            $data['error_deliveries'] = array();
        }
        ...
        if (isset($this->error['sticks'])) {
            $data['error_sticks'] = $this->error['sticks'];
        } else {
            $data['error_sticks'] = '';
        }

        if (isset($this->error['soy'])) {
            $data['error_soy'] = $this->error['soy'];
        } else {
            $data['error_soy'] = '';
        }

        if (isset($this->error['ginger'])) {
            $data['error_ginger'] = $this->error['ginger'];
        } else {
            $data['error_ginger'] = '';
        }

        if (isset($this->error['wasabi'])) {
            $data['error_wasabi'] = $this->error['wasabi'];
        } else {
            $data['error_wasabi'] = '';
        }

        if (isset($this->error['napkins'])) {
            $data['error_napkins'] = $this->error['napkins'];
        } else {
            $data['error_napkins'] = '';
        }

        if (isset($this->error['surprise'])) {
            $data['error_surprise'] = $this->error['surprise'];
        } else {
            $data['error_surprise'] = '';
        }
        ...
        if (isset($this->request->post['config_deliveries'])) {
            $data['config_deliveries'] = $this->request->post['config_deliveries'];
        } else {
            $data['config_deliveries'] = $this->config->get('config_deliveries');
        }

        if (isset($this->request->post['config_cash'])) {
            $data['config_cash'] = $this->request->post['config_cash'];
        } else {
            $data['config_cash'] = $this->config->get('config_cash');
        }

        if (isset($this->request->post['config_sticks'])) {
            $data['config_sticks'] = $this->request->post['config_sticks'];
        } else {
            $data['config_sticks'] = $this->config->get('config_sticks');
        }

        if (isset($this->request->post['config_sticks_home'])) {
            $data['config_sticks_home'] = $this->request->post['config_sticks_home'];
        } else if ($this->config->get('config_sticks_home')){
            $data['config_sticks_home'] = $this->config->get('config_sticks_home');
        } else
            $data['config_sticks_home'] = '';

        if (isset($this->request->post['config_sticks_ishome'])) {
            $data['config_sticks_ishome'] = $this->request->post['config_sticks_ishome'];
        } else {
            $data['config_sticks_ishome'] = $this->config->get('config_sticks_ishome');
        }

        if (isset($this->request->post['config_soy'])) {
            $data['config_soy'] = $this->request->post['config_soy'];
        } else {
            $data['config_soy'] = $this->config->get('config_soy');
        }

        if (isset($this->request->post['config_soy_home'])) {
            $data['config_soy_home'] = $this->request->post['config_soy_home'];
        } else if ($this->config->get('config_soy_ishome')){
            $data['config_soy_home'] = $this->config->get('config_soy_home');
        } else
            $data['config_soy_home'] = '';

        if (isset($this->request->post['config_soy_ishome'])) {
            $data['config_soy_ishome'] = $this->request->post['config_soy_ishome'];
        } else {
            $data['config_soy_ishome'] = $this->config->get('config_soy_ishome');
        }

        if (isset($this->request->post['config_ginger'])) {
            $data['config_ginger'] = $this->request->post['config_ginger'];
        } else {
            $data['config_ginger'] = $this->config->get('config_ginger');
        }

        if (isset($this->request->post['config_ginger_home'])) {
            $data['config_ginger_home'] = $this->request->post['config_ginger_home'];
        } else if ($this->config->get('config_ginger_home')){
            $data['config_ginger_home'] = $this->config->get('config_ginger_home');
        } else
            $data['config_ginger_home'] = '';

        if (isset($this->request->post['config_ginger_ishome'])) {
            $data['config_ginger_ishome'] = $this->request->post['config_ginger_ishome'];
        } else {
            $data['config_ginger_ishome'] = $this->config->get('config_ginger_ishome');
        }

        if (isset($this->request->post['config_wasabi'])) {
            $data['config_wasabi'] = $this->request->post['config_wasabi'];
        } else {
            $data['config_wasabi'] = $this->config->get('config_wasabi');
        }

        if (isset($this->request->post['config_wasabi_home'])) {
            $data['config_wasabi_home'] = $this->request->post['config_wasabi_home'];
        } else if ($this->config->get('config_wasabi_home')){
            $data['config_wasabi_home'] = $this->config->get('config_wasabi_home');
        } else
            $data['config_wasabi_home'] = '';

        if (isset($this->request->post['config_wasabi_ishome'])) {
            $data['config_wasabi_ishome'] = $this->request->post['config_wasabi_ishome'];
        } else {
            $data['config_wasabi_ishome'] = $this->config->get('config_wasabi_ishome');
        }

        if (isset($this->request->post['config_napkins'])) {
            $data['config_napkins'] = $this->request->post['config_napkins'];
        } else {
            $data['config_napkins'] = $this->config->get('config_napkins');
        }

        if (isset($this->request->post['config_napkins_home'])) {
            $data['config_napkins_home'] = $this->request->post['config_napkins_home'];
        } else if ($this->config->get('config_napkins_home')){
            $data['config_napkins_home'] = $this->config->get('config_napkins_home');
        } else
            $data['config_napkins_home'] = '';

        if (isset($this->request->post['config_napkins_ishome'])) {
            $data['config_napkins_ishome'] = $this->request->post['config_napkins_ishome'];
        } else {
            $data['config_napkins_ishome'] = $this->config->get('config_napkins_ishome');
        }

        if (isset($this->request->post['config_surprise'])) {
            $data['config_surprise'] = $this->request->post['config_surprise'];
        } else {
            $data['config_surprise'] = $this->config->get('config_surprise');
        }

        if (isset($this->request->post['config_surprise_home'])) {
            $data['config_surprise_home'] = $this->request->post['config_surprise_home'];
        } else if ($this->config->get('config_surprise_home')){
            $data['config_surprise_home'] = $this->config->get('config_surprise_home');
        } else
            $data['config_surprise_home'] = '';

        if (isset($this->request->post['config_surprise_ishome'])) {
            $data['config_surprise_ishome'] = $this->request->post['config_surprise_ishome'];
        } else {
            $data['config_surprise_ishome'] = $this->config->get('config_surprise_ishome');
        }

        if (isset($this->request->post['config_facebook'])) {
            $data['config_facebook'] = $this->request->post['config_facebook'];
        } else if ($this->config->get('config_facebook')){
        ...
        } else if ($this->config->get('config_telegram')){
        ...
        } else if ($this->config->get('config_viber')){
        ...
        } else if ($this->config->get('config_instagram')){
	...
	protected function validate() {
        ...
        if (isset($this->request->post['config_deliveries'])) {
            foreach ($this->request->post['config_deliveries'] as $language_id => $value) {
                foreach ($value as $config_delivery_id => $config_delivery) {
                    if ((utf8_strlen($config_delivery['price']) < 2) || (utf8_strlen($config_delivery['price']) > 20)) {
                        $this->error['deliveries'][$language_id][$config_delivery_id]['price'] = $this->language->get('error_price');
                    }

                    if ((utf8_strlen($config_delivery['subtitle']) < 2) || (utf8_strlen($config_delivery['subtitle']) > 30)) {
                        $this->error['deliveries'][$language_id][$config_delivery_id]['subtitle'] = $this->language->get('error_subtitle');
                    }

                    if ((utf8_strlen($config_delivery['addresses']) < 2)) {
                        $this->error['deliveries'][$language_id][$config_delivery_id]['addresses'] = $this->language->get('error_addresses');
                    }
                }
            }
        }

        if ((utf8_strlen($this->request->post['config_cash']) < 2) || (utf8_strlen($this->request->post['config_cash']) > 150)) {
            $this->error['cash'] = $this->language->get('error_delivery_cash');
        }

        if ((utf8_strlen($this->request->post['config_sticks']) < 2) || (utf8_strlen($this->request->post['config_sticks']) > 128)) {
            $this->error['sticks'] = $this->language->get('error_delivery_description');
        }

        if ((utf8_strlen($this->request->post['config_soy']) < 2) || (utf8_strlen($this->request->post['config_soy']) > 128)) {
            $this->error['soy'] = $this->language->get('error_delivery_description');
        }

        if ((utf8_strlen($this->request->post['config_ginger']) < 2) || (utf8_strlen($this->request->post['config_ginger']) > 128)) {
            $this->error['ginger'] = $this->language->get('error_delivery_description');
        }

        if ((utf8_strlen($this->request->post['config_wasabi']) < 2) || (utf8_strlen($this->request->post['config_wasabi']) > 128)) {
            $this->error['wasabi'] = $this->language->get('error_delivery_description');
        }

        if ((utf8_strlen($this->request->post['config_napkins']) < 2) || (utf8_strlen($this->request->post['config_napkins']) > 128)) {
            $this->error['napkins'] = $this->language->get('error_delivery_description');
        }

        if ((utf8_strlen($this->request->post['config_surprise']) < 2) || (utf8_strlen($this->request->post['config_surprise']) > 128)) {
            $this->error['surprise'] = $this->language->get('error_delivery_description');
        }
